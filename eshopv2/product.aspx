<%@ Page Language="C#" MasterPageFile="~/eshopDefault.Master" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="eshopv2.product" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-sm-6">
                ...
                <div class="row priceBox color-gray">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <button type="button" id="btnCart" class="btnAddToCart" onclick="AddToCart('<%=lblProductID.ClientID %>')">
                            <span class="glyphicon glyphicon-shopping-cart"></span>
                            <span class="cart-text">Dodaj u korpu</span>
                        </button>
                    </div>
                </div><!--row-->
                <div class="row icons">
    ...
    <asp:Content ID="Content3" runat="server" ContentPlaceHolderID="footerContentPlaceHolder">
