<%@ Page Title="" Language="C#" MasterPageFile="~/eshopDefault.Master" AutoEventWireup="true" CodeBehind="eshopDefault.aspx.cs" Inherits="eshopv2.eshopDefault1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" href="<%=ResolveUrl("~/css/mainMenuVerticalV2.css") %>" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-lg-2 padding-left-0 padding-right-0">
